...
## 技术文档
技术架构文档位于 `doc/技术文档/`，包括：

| 文档 | 说明 |
|------|------|
| [总体架构设计](doc/技术文档/总体架构设计.md) | 多智能体协同后端架构（deepagents + 4模块 + 注册表 + 事件总线） |
| [模块架构设计-模型检索](doc/技术文档/模块架构设计-模型检索.md) | 检索模块：API/Service/智能体/Skills |
| [模块架构设计-模型优化](doc/技术文档/模块架构设计-模型优化.md) | 优化模块：API/Service/智能体/Skills |
| [模块架构设计-模型碰撞](doc/技术文档/模块架构设计-模型碰撞.md) | 碰撞模块：API/Service/智能体/Skills |
| [模块架构设计-模型评估](doc/技术文档/模块架构设计-模型评估.md) | 评估模块：API/Service/智能体/Skills |

讨论后端架构或模块功能时优先加载对应技术文档；文档与代码冲突时以代码为准。
